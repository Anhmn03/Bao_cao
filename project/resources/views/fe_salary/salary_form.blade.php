                ...
                <div class="container-fluid">
                    ...
                    <form method="GET" action="{{ route('salary_caculate') }}">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {{-- <label for="search_month" class="d-block" style="font-size: 14px; font-weight: bold;"></label> --}}
                                    <input type="month" name="search_month" id="search_month" class="form-control" value="{{ request('search_month') }}">
                                </div>
                            </div>
